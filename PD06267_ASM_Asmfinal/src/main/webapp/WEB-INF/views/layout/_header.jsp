			...
			<div class="row">
				<div class="col-md-3">
					<div class="language-dropdown">
						<span class="language-dd">Vietnam</span>
						<ul id="language">
							<li class="">English</li>
						</ul>
					</div>
					<p class="phone-no">
						<i class="anm anm-phone-s"></i> +123456789
					</p>
				</div>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a style="text-decoration: none;" href="/"><h1 style="font-size:20px; font-weight: 600; color: rgb(39, 39, 39);	">Technology</h1> </a>
				...
				<div class="col-2 col-sm-3 col-md-3 col-lg-8">
					...
					<nav class="grid__item" id="AccessibleNav">
						...
						<ul id="siteNav" class="site-nav medium right hidearrow">
							...
							<li class="lvl1"><a href="#"><b>Mua ngay</b> <i
									class="anm anm-angle-down-l"></i></a></li>
						</ul>
					</nav>
					<!--End Desktop Menu-->
